...
if( ! class_exists('Remedial_Customizer_API_Wrapper') ) {
	class Remedial_Customizer_API_Wrapper {
		...
		public static function getInstance($options) {
			if(! self::$_instance) {
				self::$_instance = new Remedial_Customizer_API_Wrapper($options);
			}
		...
		public function add_control($wp_customize, $field_id, $field_details) {
			...
			switch ($type) {
				...
				case 'icons-picker':
					$wp_customize->add_control( 
						new Remedial_Icon_Customizer_Icon_Picker_Control(
							$wp_customize, 
							$field_id,
							array(
								'label' => isset($label) ? $label : '',
				...
				case 'posts':
					$posts_list = array();
					$posts_list[''] = __( 'Choose Post', 'remedial' );
